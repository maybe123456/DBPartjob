...
public interface SportService {
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Partjob/circleDetail")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Partjob/tieziCommentList")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Partjob/sendTieziComment")
...
//    @POST("home/fish/click")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Partjob/deleteComment")
